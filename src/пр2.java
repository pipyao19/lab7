...
public class пр2 {
    public static void main(String[] args) {
        try{
            File folder=new File("C:\\Users\\My");
            if (!folder.exists())
                folder.mkdir();
            File f1=new File("C:\\Users\\My\\strokiRand.txt");
            f1.createNewFile();
...
// Записать строки в файл
            ...
            len=rf.length();       //При вводе строк символ абзаца (нажатие Enter) имеет такой же размер
            // в байтах, как и другие символы, и учитывается при вычислении размера файла
